function sky(){
	...
	//Creamos la ventana
	var ventana = PopUpManager.createPopUp(_root, Window, true, {contentPath:"Television/Conexiones.swf"}, true);
...
function Modemp(){
	...
	var ventana = PopUpManager.createPopUp(_root, Window, true, {contentPath:"bandaancha/Modem.swf"}, true);	
	alCrear = Object();alCrear.complete = function(evento) {	
...
//////////////////////////////////////////////////// INVENTARIO EN RR ///////////////////////
function inventario(){
	var ventana = PopUpManager.createPopUp(_root, Window, true, {contentPath:"Television/inventario.swf"}, true);
	alCrear = Object();alCrear.complete = function(evento) {	
	ventana.setSize(600, 600);
	ventana.closeButton = true;
...
function agendamiento(){
	var ventana = PopUpManager.createPopUp(_root, Window, true, {contentPath:"agendamiento.swf"}, true);
	alCrear = Object();alCrear.complete = function(evento) {	
	ventana.setSize(600, 600);
	ventana.closeButton = true;
...
function CorOutExp(){
 ...
 var ventana = PopUpManager.createPopUp(_root, Window, true, {contentPath:"bandaancha/CorOutExp.swf"}, true);
 alCrear = Object();alCrear.complete = function(evento) { 
 ventana.setSize(600, 600);
 ventana.closeButton = true;
...
function Corout(){
 ...
 var ventana = PopUpManager.createPopUp(_root, Window, true, {contentPath:"bandaancha/Corout.swf"}, true);
 alCrear = Object();alCrear.complete = function(evento) { 
 ventana.setSize(600, 600);
 ventana.closeButton = true;
...
function Coreudnvo(){
 ...
 var ventana = PopUpManager.createPopUp(_root, Window, true, {contentPath:"bandaancha/Coreudnvo.swf"}, true);
 alCrear = Object();alCrear.complete = function(evento) { 
 ventana.setSize(600, 600);
 ventana.closeButton = true;
...
function Cornets(){
 ...
 var ventana = PopUpManager.createPopUp(_root, Window, true, {contentPath:"bandaancha/Cornets.swf"}, true);
 alCrear = Object();alCrear.complete = function(evento) { 
 ventana.setSize(600, 600);
 ventana.closeButton = true;
...
//////////////////////////////////////////////////// MOTOROLAs ///////////////////////
function motorolas(){
	var ventana = PopUpManager.createPopUp(_root, Window, true, {contentPath:"bandaancha/motorolas.swf"}, true);
	alCrear = Object();alCrear.complete = function(evento) {	
...
//////////////////////////////////////////////////// CLN ///////////////////////
function CLN(){
	var ventana = PopUpManager.createPopUp(_root, Window, true, {contentPath:"bandaancha/CLN.swf"}, true);
	alCrear = Object();alCrear.complete = function(evento) {	
	ventana.setSize(600, 600);
	ventana.closeButton = true;
	ventana.title = "CONECTIVIDAD LIMITADA O NULA";
...
function SOPORTE_ARRIS(){
	var ventana = PopUpManager.createPopUp(_root, Window, true, {contentPath:"bandaancha/SOPORTE_ARRIS.swf"}, true);
	alCrear = Object();alCrear.complete = function(evento) {	
...
//////////////////////////////////////////////////// Tvcondig ///////////////////////
function Tvcondig(){
	var ventana = PopUpManager.createPopUp(_root, Window, true, {contentPath:"Television/Tvcondig.swf"}, true);
	alCrear = Object();alCrear.complete = function(evento) {	
	ventana.setSize(600, 600);
	ventana.closeButton = true;
...
//////////////////////////////////////////////////// CorIncred ///////////////////////
function CorIncred(){
	var ventana = PopUpManager.createPopUp(_root, Window, true, {contentPath:"bandaancha/CorIncred.swf"}, true);
	alCrear = Object();alCrear.complete = function(evento) {	
	ventana.setSize(600, 600);
	ventana.closeButton = true;
...
//////////////////////////////////////////////////// MOTOROLA  ///////////////////////
function motorola1(){
	var ventana = PopUpManager.createPopUp(_root, Window, true, {contentPath:"Television/motorola1.swf"}, true);
	alCrear = Object();alCrear.complete = function(evento) {	
	ventana.setSize(600, 600);
	ventana.closeButton = true;
...
//////////////////////////////////////////////////// checkmate  ///////////////////////
function checkmate1(){
	var ventana = PopUpManager.createPopUp(_root, Window, true, {contentPath:"Television/checkmate1.swf"}, true);
	alCrear = Object();alCrear.complete = function(evento) {	
	ventana.setSize(600, 600);
	ventana.closeButton = true;
...
//////////////////////////////////////////////////// Moto900.swf  ///////////////////////
function Moto900(){
	var ventana = PopUpManager.createPopUp(_root, Window, true, {contentPath:"bandaancha/Moto900.swf"}, true);
	alCrear = Object();alCrear.complete = function(evento) {	
	ventana.setSize(600, 600);
	ventana.closeButton = true;
...
//////////////////////////////////////////////////// Popup.swf  ///////////////////////
function Popup(){
	var ventana = PopUpManager.createPopUp(_root, Window, true, {contentPath:"bandaancha/Popup.swf"}, true);
	alCrear = Object();alCrear.complete = function(evento) {	
	ventana.setSize(600, 600);
	ventana.closeButton = true;
	ventana.title = "Popup";
...
//////////////////////////////////////////////////// ATA.swf  ///////////////////////
function ATA(){
	var ventana = PopUpManager.createPopUp(_root, Window, true, {contentPath:"ATA.swf"}, true);
	alCrear = Object();alCrear.complete = function(evento) {	
	ventana.setSize(600, 600);
	ventana.closeButton = true;
	ventana.title = "ATA";
...
//////////////////////////////////////////////////// invlv.swf  ///////////////////////
function invlv(){
	var ventana = PopUpManager.createPopUp(_root, Window, true, {contentPath:"invlv.swf"}, true);
	alCrear = Object();alCrear.complete = function(evento) {	
	ventana.setSize(600, 600);
	ventana.closeButton = true;
	ventana.title = "invlv";
...
function Funcionalidades(){
	var ventana = PopUpManager.createPopUp(_root, Window, true, {contentPath:"Funcionalidades_pop.swf"}, true);
	alCrear = Object();alCrear.complete = function(evento) {	
	ventana.setSize(600, 600);
	ventana.closeButton = true;
	ventana.title = "Funcionalidades";
	}
	//Listener para cuando pulsamos el botón cerrar
	alCerrar = Object();
	alCerrar.click = function(evento) {
...
//////////////////////////////////////////////////// softphone.swf  ///////////////////////
function softphone(){
	var ventana = PopUpManager.createPopUp(_root, Window, true, {contentPath:"softphone_pop.swf"}, true);
	alCrear = Object();alCrear.complete = function(evento) {	
	ventana.setSize(600, 600);
	ventana.closeButton = true;
	ventana.title = "softphone";
	}
	//Listener para cuando pulsamos el botón cerrar
	alCerrar = Object();
	alCerrar.click = function(evento) {
...
//////////////////////////////////////////////////// Voicemail.swf  ///////////////////////
function Voicemail(){
	var ventana = PopUpManager.createPopUp(_root, Window, true, {contentPath:"Voicemail_pop.swf"}, true);
	alCrear = Object();alCrear.complete = function(evento) {	
	ventana.setSize(600, 600);
	ventana.closeButton = true;
	ventana.title = "Voicemail";
	}
	//Listener para cuando pulsamos el botón cerrar
	alCerrar = Object();
	alCerrar.click = function(evento) {
...
//////////////////////////////////////////////////// sa2203.swf  ///////////////////////
function sa2203(){
	var ventana = PopUpManager.createPopUp(_root, Window, true, {contentPath:"bandaancha/sa2203.swf"}, true);
	alCrear = Object();alCrear.complete = function(evento) {	
	ventana.setSize(600, 600);
	ventana.closeButton = true;
...
///////////////////////////////////////////////guia tv avanzada  ////////////////////////////
function guia1x(){
	var ventana = PopUpManager.createPopUp(_root, Window, true, {contentPath:"Television/guia1.swf"}, true);
	alCrear = Object();alCrear.complete = function(evento) {	
	ventana.setSize(750, 575);
	ventana.closeButton = true;
	ventana.title = "guia1";
	}
	//Listener para cuando pulsamos el botón cerrar
...
///////////////////////////////////////////////guia PVR  ////////////////////////////
function guia2x(){
	var ventana = PopUpManager.createPopUp(_root, Window, true, {contentPath:"Television/guia2.swf"}, true);
	alCrear = Object();alCrear.complete = function(evento) {	
	ventana.setSize(750, 575);
	ventana.closeButton = true;
	ventana.title = "guia2";
...
///////////////////////////////////////////////guia VOD  ////////////////////////////
function guia3x(){
	var ventana = PopUpManager.createPopUp(_root, Window, true, {contentPath:"Television/guia3.swf"}, true);
	alCrear = Object();alCrear.complete = function(evento) {	
	ventana.setSize(750, 575);
	ventana.closeButton = true;
	ventana.title = "guia3";
...
///////////////////////////////////////////////DTH  ////////////////////////////
function guia4x(){
	var ventana = PopUpManager.createPopUp(_root, Window, true, {contentPath:"Television/guia4.swf"}, true);
	alCrear = Object();alCrear.complete = function(evento) {	
	ventana.setSize(750, 575);
	ventana.closeButton = true;
	ventana.title = "guia4";
...
////////////////////////////////////////DHCP//////////////////////////////////////
function dhcp(){
	var ventana = PopUpManager.createPopUp(_root, Window, true, {contentPath:"bandaancha/validar_dhcp.swf"}, true);
	alCrear = Object();alCrear.complete = function(evento) {	
	ventana.setSize(600, 600);
	ventana.closeButton = true;
...
function grillabi(){
	...
	//import mx.containers.Window;
	//Creamos la ventana
	var ventana = PopUpManager.createPopUp(_root, Window, true, {contentPath:"Television/grillabi.swf"}, true);
	alCrear = Object();alCrear.complete = function(evento) {	
	ventana.setSize(690, 711);
	ventana.closeButton = true;
	ventana.title = "grillabi.";
	}
	//Listener para cuando pulsamos el botón cerrar
	alCerrar = Object();
	alCerrar.click = function(evento) {
...
function grillauni(){
	...
	//import mx.containers.Window;
	//Creamos la ventana
	var ventana = PopUpManager.createPopUp(_root, Window, true, {contentPath:"Television/grillauni.swf"}, true);
	alCrear = Object();alCrear.complete = function(evento) {	
	ventana.setSize(690, 711);
	ventana.closeButton = true;
	ventana.title = "grillauni.";
	}
	//Listener para cuando pulsamos el botón cerrar
	alCerrar = Object();
	alCerrar.click = function(evento) {
...
/////NUEVOS DECOS  ///////////////////////////////////////////////DECO1();//////////////////////
function DECO1(){
	var ventana = PopUpManager.createPopUp(_root, Window, true, {contentPath:"Television/DECO1.swf"}, true);
	alCrear = Object();alCrear.complete = function(evento) {	
	ventana.setSize(600, 590);
	ventana.closeButton = true;
	ventana.title = "Verif...DC 700";
	}
	//Listener para cuando pulsamos el botón cerrar
	alCerrar = Object();
	alCerrar.click = function(evento) {
...
/////NUEVOS DECOS  ///////////////////////////////////////////////DECO2();//////////////////////
function DECO2(){
	var ventana = PopUpManager.createPopUp(_root, Window, true, {contentPath:"Television/DECO2.swf"}, true);
	alCrear = Object();alCrear.complete = function(evento) {	
	ventana.setSize(600, 590);
	ventana.closeButton = true;
	ventana.title = "Verif...DCT3416";
	}
	//Listener para cuando pulsamos el botón cerrar
	alCerrar = Object();
	alCerrar.click = function(evento) {
...
/////NUEVOS DECOS  ///////////////////////////////////////////////DECO3();//////////////////////
function DECO3(){
	var ventana = PopUpManager.createPopUp(_root, Window, true, {contentPath:"Television/DECO3.swf"}, true);
	alCrear = Object();alCrear.complete = function(evento) {	
	ventana.setSize(600, 590);
	ventana.closeButton = true;
	ventana.title = "Verif...DCX3200";
	}
	//Listener para cuando pulsamos el botón cerrar
	alCerrar = Object();
	alCerrar.click = function(evento) {
...
/////NUEVOS DECOS  ///////////////////////////////////////////////DECO4();//////////////////////
function DECO4(){
	var ventana = PopUpManager.createPopUp(_root, Window, true, {contentPath:"Television/DECO4.swf"}, true);
	alCrear = Object();alCrear.complete = function(evento) {	
	ventana.setSize(600, 590);
	ventana.closeButton = true;
	ventana.title = "Verif...DCX3400";
	}
	//Listener para cuando pulsamos el botón cerrar
	alCerrar = Object();
	alCerrar.click = function(evento) {
